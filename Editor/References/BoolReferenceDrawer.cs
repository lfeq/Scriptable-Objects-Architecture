...
namespace Scriptable_Objects_Architecture.Editor.References {
    ...
    public class BoolReferenceDrawer : PropertyDrawer {
        public override VisualElement CreatePropertyGUI(SerializedProperty property) {
            ...
            toggleField.BindProperty(constantValueProp);
            toggleField.style.flexGrow = 1;
            var objectField = new ObjectField();
            objectField.objectType = typeof(BoolVariable);
            ...
            Action<bool> updateFieldDisplay = (useConstant) => {
                ...
                fieldContainer.Add(useConstant ? toggleField : objectField);
            };
